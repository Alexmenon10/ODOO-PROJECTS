...
class DirectDeliveryIndent(models.Model):
    ...
    current_reporting_manager = fields.Many2one(related='delivery_responsible.parent_id', string="Reporting Manager")
    ...
    requester_current_reporting_manager = fields.Many2one('hr.employee', string="Reporting Manager",
                                                          related='delivery_request_raised_for.parent_id')
            ...
            if not self.stock_picking_id:
                ...
                if self.picking_type_id.code == 'outgoing':
                    pick = {
                        ...
                        'delivery_receiver': order.delivery_request_raised_for.user_id.employee_id.id or order.delivery_responsible.user_id.employee_id.id,
                        'ho_department': order.ho_department.id,
